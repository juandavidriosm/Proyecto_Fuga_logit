...
df_fuga_sinObj = pd.read_csv("Out/df_fuga_sinObj.csv")
...
df_fuga_sinObj = df_fuga_sinObj[df_fuga_completo.columns]
...
predictions_finales = pipe_model_interac.predict(df_fuga_sinObj)
df_fuga_sinObj["Fuga"] = predictions_finales

df_fuga_sinObj.to_csv("Out/PrediccionesFinales.csv")
